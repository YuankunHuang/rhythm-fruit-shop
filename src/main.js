...
const NOTE_FRUIT_ICON_SETS={day:{Apple:lazyImage('assets/fruit_notes/day/apple.png'),Orange:lazyImage('assets/fruit_notes/day/orange.png'),Lime:lazyImage('assets/fruit_notes/day/lime.png'),Banana:lazyImage('assets/fruit_notes/day/banana.png'),Grape:lazyImage('assets/fruit_notes/day/grape.png'),Lemon:lazyImage('assets/fruit_notes/day/lemon.png')},night:{Apple:lazyImage('assets/fruit_notes/night/apple.png'),Orange:lazyImage('assets/fruit_notes/night/orange.png'),Lime:lazyImage('assets/fruit_notes/night/lime.png'),Banana:lazyImage('assets/fruit_notes/night/banana.png'),Grape:lazyImage('assets/fruit_notes/night/grape.png'),Lemon:lazyImage('assets/fruit_notes/night/lemon.png')},sunny:{Apple:lazyImage('assets/fruit_notes/sunny/apple.png'),Orange:lazyImage('assets/fruit_notes/sunny/orange.png'),Lime:lazyImage('assets/fruit_notes/sunny/lime.png'),Banana:lazyImage('assets/fruit_notes/sunny/banana.png'),Grape:lazyImage('assets/fruit_notes/sunny/grape.png'),Lemon:lazyImage('assets/fruit_notes/sunny/lemon.png')}};
...
const MAIN_VISUALS={
  day:{landscape:lazyImage('assets/game_art/clean_mobile/main_visual_landscape.png'),portrait:lazyImage('assets/game_art/clean_mobile/main_visual_portrait.png')},
  night:{landscape:lazyImage('assets/game_art/neon_night/main_visual_landscape.png'),portrait:lazyImage('assets/game_art/neon_night/main_visual_portrait.png')},
  sunny:{landscape:lazyImage('assets/game_art/sunny_shop/main_visual_landscape.png'),portrait:lazyImage('assets/game_art/sunny_shop/main_visual_portrait.png')}
};
const HOME_SPACES={
  apartment:{title:'廉租小屋',subtitle:'窗外天亮了。房租不会等人，今天也得去店里。',landscape:lazyImage('assets/game_art/home/apartment_landscape.png'),portrait:lazyImage('assets/game_art/home/apartment_portrait.png')},
  shopDorm:{title:'店铺阁楼',subtitle:'楼下就是柜台。这里终于像一个能落脚的地方。',landscape:lazyImage('assets/game_art/home/shop_dorm_landscape.png'),portrait:lazyImage('assets/game_art/home/shop_dorm_portrait.png')}
};
const SHOP_INTERIORS={
  sunny:{landscape:lazyImage('assets/game_art/sunny_shop/shop_interior_landscape.png'),portrait:lazyImage('assets/game_art/sunny_shop/shop_interior_portrait.png')}
};
...
const VN_CHARACTERS={
  yuzu:{side:'right',assets:{neutral:lazyImage('assets/game_art/yuzu/neutral.png'),smile:lazyImage('assets/game_art/yuzu/smile.png'),teasing:lazyImage('assets/game_art/yuzu/teasing.png'),deadpan:lazyImage('assets/game_art/yuzu/deadpan.png'),annoyed:lazyImage('assets/game_art/yuzu/annoyed.png'),panic:lazyImage('assets/game_art/yuzu/panic.png'),relieved:lazyImage('assets/game_art/yuzu/relieved.png'),serious:lazyImage('assets/game_art/yuzu/serious.png'),sigh:lazyImage('assets/game_art/yuzu/sigh.png')}},
  student_girl:{side:'left',assets:{neutral:lazyImage('assets/game_art/student_girl/neutral.png'),tired:lazyImage('assets/game_art/student_girl/tired.png'),smile:lazyImage('assets/game_art/student_girl/smile.png'),awkward:lazyImage('assets/game_art/student_girl/awkward.png')}},
  ashen:{side:'left',assets:{neutral:lazyImage('assets/game_art/a_sheng/neutral.png'),tired:lazyImage('assets/game_art/a_sheng/tired.png'),focused:lazyImage('assets/game_art/a_sheng/focused.png')}},
  chengwan:{side:'left',assets:{neutral:lazyImage('assets/game_art/cheng_wan/neutral.png'),tired:lazyImage('assets/game_art/cheng_wan/tired.png'),professional_smile:lazyImage('assets/game_art/cheng_wan/professional_smile.png')}},
  guiwei:{side:'left',assets:{neutral:lazyImage('assets/game_art/gu_wei/neutral.png'),lost_in_thought:lazyImage('assets/game_art/gu_wei/lost_in_thought.png'),rare_smile:lazyImage('assets/game_art/gu_wei/rare_smile.png')}},
  laobei:{side:'left',assets:{neutral:lazyImage('assets/game_art/lao_bei/neutral.png'),nostalgic_smile:lazyImage('assets/game_art/lao_bei/nostalgic_smile.png'),attentive:lazyImage('assets/game_art/lao_bei/attentive.png')}},
  laofang:{side:'left',assets:{neutral:lazyImage('assets/game_art/lao_fang/neutral.png'),weary:lazyImage('assets/game_art/lao_fang/weary.png'),warm_smile:lazyImage('assets/game_art/lao_fang/warm_smile.png')}},
  laoxian:{side:'left',assets:{neutral:lazyImage('assets/game_art/lao_xian/neutral.png'),pensive:lazyImage('assets/game_art/lao_xian/pensive.png'),quiet_warmth:lazyImage('assets/game_art/lao_xian/quiet_warmth.png')}},
  miss_cat:{side:'left',assets:{neutral:lazyImage('assets/game_art/mao_xiao_jie/neutral.png'),curious:lazyImage('assets/game_art/mao_xiao_jie/curious.png'),smile:lazyImage('assets/game_art/mao_xiao_jie/smile.png')}},
  mianju:{side:'left',assets:{neutral:lazyImage('assets/game_art/mian_ju/neutral.png'),detached:lazyImage('assets/game_art/mian_ju/detached.png'),micro_smile:lazyImage('assets/game_art/mian_ju/micro_smile.png')}},
  xieyin:{side:'left',assets:{neutral:lazyImage('assets/game_art/xie_yin/neutral.png'),composed_listening:lazyImage('assets/game_art/xie_yin/composed_listening.png'),slight_smile:lazyImage('assets/game_art/xie_yin/slight_smile.png')}},
  yanzi:{side:'left',assets:{neutral:lazyImage('assets/game_art/yan_zi/neutral.png'),sharp_alert:lazyImage('assets/game_art/yan_zi/sharp_alert.png'),grin:lazyImage('assets/game_art/yan_zi/grin.png')}},
  yuange:{side:'left',assets:{neutral:lazyImage('assets/game_art/yuan_ge/neutral.png'),quiet_content:lazyImage('assets/game_art/yuan_ge/quiet_content.png'),thoughtful:lazyImage('assets/game_art/yuan_ge/thoughtful.png')}},
  yueshu:{side:'left',assets:{neutral:lazyImage('assets/game_art/yue_shu/neutral.png'),dreamy:lazyImage('assets/game_art/yue_shu/dreamy.png'),quiet_smile:lazyImage('assets/game_art/yue_shu/quiet_smile.png')}},
  xiaobing:{side:'left',assets:{neutral:lazyImage('assets/game_art/xiao_bing/neutral.png'),focused:lazyImage('assets/game_art/xiao_bing/focused.png'),uncertain:lazyImage('assets/game_art/xiao_bing/uncertain.png')}},
  laosong:{side:'left',assets:{neutral:lazyImage('assets/game_art/lao_song/neutral.png'),hollow:lazyImage('assets/game_art/lao_song/hollow.png'),composed:lazyImage('assets/game_art/lao_song/composed.png')}},
  wuming:{side:'left',assets:{neutral:lazyImage('assets/game_art/wu_ming/neutral.png')}}
};
...
function effectiveDiscreteTag(){if(!inStoryShellForTheme())return preferenceDiscreteTag();if((dayRun&&dayRun.active)||(serviceRun&&serviceRun.active)||(state===S.ENDED&&resultMode==='shift'))return slotDiscreteTag(activeSlotId||'day');return slotDiscreteTag(firstUnlockedSlotId())}
...
function themeLogo(){return isNightTheme()?'assets/game_art/neon_night/brand_logo.png':isSunnyTheme()?'assets/game_art/sunny_shop/brand_logo.png':'assets/game_art/clean_mobile/brand_logo.png'}
...
function songSnapshot(s){return s&&s.cover?versionedUrl(s.cover):(s&&s.id?versionedUrl(`assets/songs/${s.id}/cover.png`):'')}
...
function buildBossLetterNodes(L,pos){
  ...
  if(pos==='after_home'){
    ...
    else if(d==='yuzu_hands_you')nodes.push({text:'柚子跟进屋，把信封往桌上一丢：「我读过了。你该读你的。」'})
    else if(mailboxshell)nodes.push({text:'你回到住处——桌上安安静静躺着一只信封。没有邮戳，只有一行熟得讨厌的总部落款。'})
    else nodes.push({text:'收工回信。桌面上那封信像在等你把围裙解下来才敢开口。'})
    ...
    else if(mailboxshell)nodes.push({text:'对话刚落地，你的眼睛先一步看见了台面——不知何时多了一只信封，角上折得过分整齐。'})
  ...
  if(d==='mailbox_intro'||d==='yuzu_hands_you'||mailboxshell)nodes.push({speaker:'柚子',text:'我读过了——差不多就是你理解的样子。细节别指望从我这儿套全。'})
  return nodes
}
...
function pauseGame(){if(![S.READY,S.LEAD_IN,S.PLAYING,S.RESUME_COUNTDOWN].includes(state))return;if(state===S.PLAYING)playbackVisualTime=songTime();if(state!==S.RESUME_COUNTDOWN)pausedFromState=state;state=S.PAUSED;resumeCountdown=0;holding=false;audio.pause();sfxPlay('game.pause')}
